# MHKiT Loads Module Example Ingestion Pipeline

The MHKiT Loads Module Example ingestion pipeline was created from a cookiecutter template. This README file contains
