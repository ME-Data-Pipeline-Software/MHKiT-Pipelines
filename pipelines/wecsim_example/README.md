# MHKiT WEC-Sim Example Ingestion Pipeline

The MHKiT WEC-Sim Example ingestion pipeline was created from a cookiecutter template. This README file contains
