# MHKiT CDIP IO Example Ingestion Pipeline

The MHKiT CDIP IO Example ingestion pipeline was created from a cookiecutter template. This README file contains
