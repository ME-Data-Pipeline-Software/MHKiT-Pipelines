# MHKiT Tidal Module Example Ingestion Pipeline

The MHKiT Tidal Module Example ingestion pipeline was created from a cookiecutter template. This README file contains
