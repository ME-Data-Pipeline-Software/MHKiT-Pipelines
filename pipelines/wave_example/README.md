# MHKiT Wave Module Example Ingestion Pipeline

The MHKiT Wave Module Example ingestion pipeline was created from a cookiecutter template. This README file contains
